          ...
          <div className="max-w-7xl mx-auto">
            ...
            {articles.length === 0 ? (
              <div className="text-center py-20">
                <p className="text-brand-silver text-lg italic">
                ...
                {articles.map((article: any) => {
                  ...
                  return (
                    <Link
                      ...
                      className="group block rounded-3xl overflow-hidden border border-white/8 transition-all duration-300 hover:border-brand-blue/30"
                      style={{
                    ...
                    >
                      ...
                      <div className="relative aspect-[3/2] overflow-hidden">
                        {coverUrl ? (
                          ...
                          <div className="w-full h-full bg-gradient-to-br from-brand-dark via-[#1a2744] to-brand-dark" />
                        )}
                        {/* Category badge */}
                        {article.category && (
                          <span className="absolute top-4 left-4 px-3 py-1 text-[11px] uppercase tracking-wider text-brand-blue bg-brand-dark/80 backdrop-blur-md rounded-full border border-white/10">
                            {article.category}
                          </span>
                        )}
                      </div>
                      ...
                      {/* Content */}
                      <div className="p-6">
                        <h2 className="font-serif text-xl md:text-2xl text-white mb-2 group-hover:text-brand-blue transition-colors leading-tight">
                          {article.title}
                        </h2>
                        {article.excerpt && (
                          <p className="text-brand-silver text-sm leading-relaxed line-clamp-3 mb-4">
                            {article.excerpt}
                          </p>
                        )}

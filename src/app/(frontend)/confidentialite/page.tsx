      ...
      <main className="relative min-h-screen bg-brand-dark pt-32 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-brand-silver text-base leading-relaxed font-sans">
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Collecte des Données</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Utilisation des Données</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Vos Droits</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Durée de Conservation</h2>
              <p>

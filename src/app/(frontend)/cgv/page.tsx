      ...
      <main className="relative min-h-screen bg-slate-50 dark:bg-brand-dark transition-colors duration-700 pt-32 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-slate-600 dark:text-brand-silver text-base leading-relaxed font-sans">
            <section>
              <h2 className="font-serif text-2xl text-slate-900 dark:text-white mb-4">Objet</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-slate-900 dark:text-white mb-4">Réservation</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-slate-900 dark:text-white mb-4">Tarifs</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-slate-900 dark:text-white mb-4">Annulation</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-slate-900 dark:text-white mb-4">Responsabilité</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-slate-900 dark:text-white mb-4">Litiges</h2>
              <p>

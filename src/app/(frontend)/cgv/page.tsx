      ...
      <main className="relative min-h-screen bg-brand-dark pt-32 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-brand-silver text-base leading-relaxed font-sans">
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Objet</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Réservation</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Tarifs</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Annulation</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Responsabilité</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif text-2xl text-white mb-4">Litiges</h2>
              <p>

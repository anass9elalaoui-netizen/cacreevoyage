...
export default async function NationalDestinationsPage() {
  ...
  return (
    <main className="relative w-full min-h-screen bg-[#0B132B] overflow-x-hidden">
      ...
      <section className="relative w-full px-4 md:px-12 lg:px-20 pb-32">
        {/* Ambient Glow */}
        <div className="absolute top-1/3 right-1/4 w-[300px] h-[300px] bg-brand-blue/5 rounded-full blur-[120px] pointer-events-none" />
        ...
        {destinations.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center relative z-10">
            ...
            <p className="text-white/40">Nos experts préparent actuellement nos itinéraires nationaux.</p>
          </div>
        )}
      </section>
